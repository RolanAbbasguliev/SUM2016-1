...
VOID MM3_Render( VOID )
{
  ...
  if (MM3_Anim.KeysClick[VK_ESCAPE])
    PostMessage(MM3_Anim.hWnd, WM_CLOSE, 0, 0);
  if (MM3_Anim.KeysClick[VK_F2])
    MM3_IsSysInfo = !MM3_IsSysInfo;
  if (MM3_Anim.KeysClick[VK_F3])
    MM3_IsKeyInfo = !MM3_IsKeyInfo;
